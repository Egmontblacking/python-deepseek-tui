...
▏ 
    python-deepseek-tui/
    ├── README.md          ← 使用指南与源码解析 (本文档)
    ├── main.py            ← 入口
    ├── cli.py             ← CLI + 配置
    ├── client.py          ← API 客户端 (SSE/TokenBucket/重试)
    ├── engine.py          ← 对话引擎 (turn loop)
    ├── tools.py           ← 工具系统 (6 工具)
    ├── session.py         ← 会话持久化
    ├── tui.py             ← 终端界面
    ├── test_local.py      ← 集成测试
...
▏ │ 章节                                                                 │ 内容                                                                 │
▏ ├──────────────────────────────────────────────────────────────────────┼──────────────────────────────────────────────────────────────────────┤
▏ │ §1-2 快速开始 + 使用指南                                             │ 安装、配置、三种模式、审批、会话管理                                 │
▏ ├──────────────────────────────────────────────────────────────────────┼──────────────────────────────────────────────────────────────────────┤
▏ │ §3 架构总览                                                          │ 模块关系图 + 数据流全景                                              │
▏ ├──────────────────────────────────────────────────────────────────────┼──────────────────────────────────────────────────────────────────────┤
▏ │ §4 入口与 CLI                                                        │ 启动流程 + load_config 源码                                          │
▏ ├──────────────────────────────────────────────────────────────────────┼──────────────────────────────────────────────────────────────────────┤
▏ │ §5 API 客户端                                                        │ SSE 流程 + TokenBucket + 连接健康状态机 + 事件类型表                 │
▏ ├──────────────────────────────────────────────────────────────────────┼──────────────────────────────────────────────────────────────────────┤
▏ │ §6 工具系统                                                          │ 6 工具 + ToolRegistry + 幻觉 5 级解析 + 工具执行流程                 │
▏ ├──────────────────────────────────────────────────────────────────────┼──────────────────────────────────────────────────────────────────────┤
▏ │ §7 对话引擎                                                          │ ChatEngine + Turn Loop + 三模式系统提示 + 审批回调注入               │
▏ ├──────────────────────────────────────────────────────────────────────┼──────────────────────────────────────────────────────────────────────┤
▏ │ §8 会话持久化                                                        │ JSON 格式 + save/load/list 操作                                      │
▏ ├──────────────────────────────────────────────────────────────────────┼──────────────────────────────────────────────────────────────────────┤
▏ │ §9 终端界面                                                          │ TerminalUI + 事件渲染细节 + 命令面板                                 │
▏ ├──────────────────────────────────────────────────────────────────────┼──────────────────────────────────────────────────────────────────────┤
▏ │ §10 完整数据流                                                       │ 一次交互的完整时间线 + 设计决策 + Rust 版对比                        │
▏ └──────────────────────────────────────────────────────────────────────┴──────────────────────────────────────────────────────────────────────┘
